========================================================================
       MICROSOFT FOUNDATION CLASS ライブラリ : F2FSetup
========================================================================


AppWizard が生成した F2FSetup には、Microsoft Foundation Class の基本的な
使い方が示されています。アプリケーション作成のひな型としてお使いください。

このファイルには F2FSetup を構成している各ファイルの概要説明が含まれています。
...
F2FSetup.h
    ...
    みます） をインクルードし、また CF2FSetupApp アプリケーションクラスを宣
    言します。

F2FSetup.cpp
    このファイルは CF2FSetupApp アプリケーションクラスを含むアプリケーション
    の中心となるソースファイルです。
...
res\F2FSetup.ico
    ...
    ルです。このアイコンはリソース ファイル F2FSetup.rc によってインクルード
    されます。
...
F2FSetupDlg.h, F2FSetupDlg.cpp - ダイアログ
    これらのファイルは CF2FSetupDlg クラスを含みます。このクラスは 
    アプリケーションのメイン ダイアログの動作を定義します。ダイアログ
    テンプレートは Microsoft Visual C++ で編集可能な F2FSetup.rc に含
    まれます。
...
StdAfx.h, StdAfx.cpp
    これらのファイルはプリコンパイル済ヘッダー ファイル (PCH) F2FSetup.pch 
